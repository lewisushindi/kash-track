...
<div class="container pt-20 px-6 mx-auto">
        ...
        <div class="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
          <form>
            ...
            <div class="form-group form-check text-center mb-6">
              ...
              <label class="form-check-label inline-block text-gray-800" for="exampleCheck87">Send us a copy of this
                message</label>
            </div>
  ...
  <footer class="text-center lg:text-left bg-gray-100 text-gray-600">
    ...
    <div class="text-center p-6 bg-blue-700 text-white">
      <span>© 2023 Copyright:</span>
      <a class="text-white font-semibold" href="#">Tailwind Elements</a>
    </div>
  </footer>
